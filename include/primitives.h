...
void add8(bit_t carry, fixed_bitspan_t<8> out, const fixed_bitspan_t<8>  a, const fixed_bitspan_t<8> b, TFHEServerParams_t p);
void add16(bit_t carry, fixed_bitspan_t<16> out, const fixed_bitspan_t<16>  a, const fixed_bitspan_t<16> b, TFHEServerParams_t p);
void mul8(fixed_bitspan_t<16> out, const fixed_bitspan_t<8> a, const fixed_bitspan_t<8> b, TFHEServerParams_t p);
void mul16(fixed_bitspan_t<32> out, const fixed_bitspan_t<16> a, const fixed_bitspan_t<16> b, TFHEServerParams_t p);
